...
####      a. we converted the "Male" and "Female" that we found under the Column of "SonsCnt" and replaced it with the correct response of 1 = Male and 2 = Female. 
####      b. we rounded the PostHeldYrs to the nearest integer 
...
### 3 Clenup: Remove Unused Environment Variables
...
### 4_b: The below table provides the descriptive statistics for Age, Income, HDI, and the 4 Mean columns and create a histogram of any 2.
...
### 5_b: We have provided a Barchart of the Top 15 Nations by the average Decisional Procrastination Scores. 
...
### 5_c: We have provided a Barchart of the Top 15 Nations by the average Generalized Procrastination Scores. 
```{r  5c_Top_15_GP}
...
##### The Bar Chart has been filled with different colors for each HDI Category (V.High, High, Med, and Low). As can be seen in the chart, none of the top 15 countries with the highest GP score come from coutries that had Low HDI Scores.

### 5_c: 8 countries show up on both the above 2 plots. They are listed below for easy reference.
...
### 5_d: The below plot provide us relationship between Age and Annual Income and is grouped by Gender. 
...
### 5_d: The below plot provide us relationship between Age and Annual Income and is grouped by Gender. However, it this plot only inclues the 8 countries that were common in the Top 15 DP and Top 15 GP list. 
...
### 5_e: We have provided a Barchart of the Mean Life Satisfaction scores by HDI Cagegory. 
